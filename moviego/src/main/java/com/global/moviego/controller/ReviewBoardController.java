...
//	}
	...
	public String reviewList(Model model, PageVO vo) {
        ...
        // 결과를 출력해 확인
        System.out.println(getPageLength.get("pages"));
                
        model.addAttribute("page", startPage);
        model.addAttribute("pages", getPageLength.get("pages"));
		return "board/list";
	}
	
	/*
	 * List<ReviewBoardVO> list = new ArrayList<ReviewBoardVO>(); list =
	 * reviewBoardService.selectReviewService(); model.addAttribute("list", list);
	 */
